             ...
             // Compute tax for married jointly filers
               if (income <= 18550){
                 ...
                 taxRate = 33;
                  ...
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
                       (151900 - 75300) * 0.25 + (income - 151900) * 0.28; +
                       (income - 231450) * 0.33 + (income - 413350) * 0.35 + (income - 466951) * .396;
                  taxRate = 39.6;
               }//end of nested if
          ...
          *******************************************************************************/
             ...
             // Compute tax for married seperately filers
               if (income <= 9275){
                 ...
                 tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                       (91150 - 37650) * 0.25 + (income - 75951) * 0.28;
                 taxRate = 28;
               }//end of else if
             ...
             // Compute tax for head of household filers
               if (income <= 13250){
                 ...
                 taxRate = 33;
                  ...
                  tax = 13250 * 0.10 + (income - 13250) * 0.15 + (income - 50400) * 0.25+ (income - 130150) * 0.28 +
                       (income - 1210800) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 13250 * 0.10 + (income - 13250) * 0.15 + (income - 50400) * 0.25+ (income - 130150) * 0.28 +
                       (income - 1210800) * 0.33 + (income - 413350) * 0.35 + (income - 441000) * .396;
                  taxRate = 39.6;
               }//end of nested if
